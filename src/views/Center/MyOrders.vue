<template>
  <div class="order-right">
    <div class="order-content">
      ...
      <div class="orders">
        <table class="order-item" v-for="order in myOrdersList" :key="order.id">
          <thead>
            <tr>
              <th colspan="5">
...
import { useMyOrdersStore } from '../../stores/center.js'
import Pagination from '../../components/Pagination.vue'

const { getMyOrders, updatePageNo } = useMyOrdersStore()
const { pageNo, limit, myOrdersList, total, totalPages } = storeToRefs(useMyOrdersStore())
