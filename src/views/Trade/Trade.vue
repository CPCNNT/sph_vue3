  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div
        ...
        :key="address.id"
        @click="changeSelectedAddress(address, userAddressList)"
      >
        <span
          class="username"
        ...
        <p>
          ...
          <span class="s3" v-show="address.id === defaultAddressId">默认地址</span>
        </p>
      </div>
      <div class="line"></div>
      ...
      <div class="bbs">
        <h5>买家留言：</h5>
        <textarea placeholder="建议留言前先与商家沟通确认" rows="4" class="remarks-cont" v-model.lazy="msg"></textarea>
      </div>
      <div class="line"></div>
      <div class="bill">
        <h5>发票信息：</h5>
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        <span>寄送至：{{ selectedAddress.fullAddress }}，</span>
        <span>收货人：{{ selectedAddress.consignee }}，</span>
        <span>手机：{{ selectedAddress.phoneNum }}</span>
      </div>
    </div>
...
function changeSelectedAddress(address, addressList) {
